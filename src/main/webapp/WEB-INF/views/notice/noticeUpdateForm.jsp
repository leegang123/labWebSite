...
<div class="container">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">${notice.noticeIdx}번째 공지사항 수정화면</div>
        <div class="panel-body">
            <form class="form-horizontal" action="${contextPath}/noticeUpdate.do" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea name="noticeContent" id="noticeContent" class="form-control" rows="20">${notice.noticeContent}</textarea>
                    </div>
                </div>
                <div class="form-group">
